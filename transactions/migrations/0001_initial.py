    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_date', models.DateTimeField(default=datetime.datetime(2024, 10, 23, 23, 26, 14, 150184, tzinfo=datetime.timezone.utc))),
        ...
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['is_returned'], name='transaction_is_retu_cc6848_idx'),
        ),
    ]
