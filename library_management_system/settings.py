...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-d2)i4ro7&-wweq##hqwu&rarp7!o3qp8d-o2g^2qzcmqm9_4+h')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['Collekta.pythonanywhere.com', '127.0.0.1']
...
CELERY_BROKER_URL = 'redis://127.0.0.1:6379/0' # Redis as a broker
...
CELERY_CACHE_BACKEND = 'redis://l127.0.0.1:6379/1'
...
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'jqmnvbgpbfxcjdrr')
